        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 text-gray-900">
            <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div className="bg-blue-600 p-8 text-white text-center">
                    ...
                    <p className="mt-2 text-blue-100 italic">{job.title} @ {job.company}</p>
                </div>

                <form onSubmit={handleApply} className="p-8 md:p-12 space-y-6">
                    {/* Read-only email field */}
                    <div className="form-control">
                        <label className="label text-gray-700 font-bold mb-1">আপনার ইমেইল (অপরিবর্তনযোগ্য)</label>
                        <input 
                            type="email" 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="form-control">
                            <label className="label text-gray-700 font-bold mb-1">LinkedIn প্রোফাইল লিঙ্ক</label>
                            <input 
                                type="url" 
                                name="linkedin" 
                        ...
                        <div className="form-control">
                            <label className="label text-gray-700 font-bold mb-1">GitHub প্রোফাইল লিঙ্ক</label>
                            <input 
                                type="url" 
                                name="github" 
                    ...
                    <div className="form-control">
                        <label className="label text-gray-700 font-bold mb-1">রেজ্যুমে/সিভি ড্রাইভ লিঙ্ক</label>
                        <input 
                            type="url" 
                            name="resume" 
                            ...
                            required 
                        />
                        <p className="text-xs text-gray-400 mt-2">*নিশ্চিত করুন যে ড্রাইভ লিঙ্কটির 'Public Access' অন আছে।</p>
                    </div>
